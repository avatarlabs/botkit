...
function Facebookbot(configuration) {
    ...
    facebook_botkit.middleware.format.use(function(bot, message, platform_message, next) {
        ...
        if (!message.sender_action) {
            ...
            // https://github.com/howdyai/botkit/pull/1301
    ...
    facebook_botkit.defineBot(function(botkit, config) {
        ...
        bot.replyWithTyping = function(src, resp, cb) {
            ...
            bot.startTyping(src, function(err) {
                ...
                setTimeout(function() {
                    ...
                    bot.replyContinued(src, resp, cb);
                }, typingLength);
            });

        };

        bot.replyContinued = function(src, resp, cb) {
            var msg = {};
        ...
        bot.reply = function(src, resp, cb) {
            ...
            //bot.say(msg, cb);
            if (facebook_botkit.config.replyWithTyping) {
    ...
    // handle delivery messages -- https://github.com/howdyai/botkit/pull/1312
