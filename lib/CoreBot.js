...
function Botkit(configuration) {
    ...
    botkit.trigger = function(event, data) {
        if (this.events[event]) {
            ...
            botkit.debug('checking ' + random_hearing.length + ' hear patterns on event type ' + event);
            ...
            botkit.debug('no matches hearing on ' + event + ', checking ' + handlers.length + ' remaining event handlers');
